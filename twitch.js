...
const responses = {
    ...
    server: 'Привет! Хочешь попасть на наш сервер? У нас есть два способа: 1. БЕСПЛАТНЫЙ Способ! Просто смотри наш стрим на Twitch и накопи 1000 баллов за 20-30 минут! Потрать их на проходку, подпишись на Telegram (https://t.me/+dt8Sh8x762FmYWYy ) и оставь свой ник в комментариях. Мы свяжемся с тобой! 2. ПЛАТНЫЙ Способ! Оплати проходку за 200 рублей через DonationAlerts ( !донат ). Всё просто, и ты в игре! Стримы: с 10:00 до 12:00 с 18:00 до 22:00  Ждём тебя в игре'
};
